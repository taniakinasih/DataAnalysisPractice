...
def select_relevant_columns(df: pd.DataFrame) -> pd.DataFrame:
    cols = ["year","month", "day", "hour","pm2.5", "DEWP", "TEMP", "PRES", "Iws", "Ir", "season"]
...
def parse(path: str) -> pd.DataFrame:
    ...
    round_cols = [c for c in numeric_cols if c in [
        "concentration", "dew point", "temperature",
        "pressure", "wind speed", "rainfall duration"
    ]]
